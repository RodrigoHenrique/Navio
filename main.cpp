...
int main(int argc, char** argv) {
	...
	Embarcacao *embarcacao_teste1 = new Embarcacao("Balerion",data_teste,"Rodrigo",porto_teste.get_nome_porto());
	Embarcacao *embarcacao_teste2 = new Embarcacao("Meraxes",data_teste,"Rodrigo",porto_teste.get_nome_porto());
	Embarcacao *embarcacao_teste3 = new Embarcacao("Vhagar",data_teste,"Rodrigo",porto_teste.get_nome_porto());
